...
Go to [http://localhost:777/](http://localhost:777/) in your browser to see the demo page. The demo itself is located in `Router-demo` folder, with an entry file of `Index.ts` that loads the module `Router-demo/Main`.
