...
describe('Router/MaskResolver', () => {
    describe('#getAppNameByUrl', () => {
        it('returns index component name', () => {
            expect(getAppNameByUrl('/Website/Register')).toEqual(
                'Website/Index'
            );
        });

        it('ignores query params if they are separated by slash', () => {
            expect(getAppNameByUrl('/MainPage/?waittime=100')).toEqual(
                'MainPage/Index'
            );
        });

        it('ignores query params if they are NOT separated by slash', () => {
            expect(getAppNameByUrl('/ServerStatus?timeout=500')).toEqual(
                'ServerStatus/Index'
            );
        });
    ...
    describe('MaskResolver class', () => {
        ...
        const routerUrl = new RouterUrl(
            _location,
            UrlRewriterTest.getInstance()
        );
        const maskResolver = new MaskResolver(
            UrlRewriterTest.getInstance(),
            routerUrl
        );
        ...
        describe('#calculateUrlParams', () => {
            ...
            it('decodes encoded forward slash', () => {
                ...
                const url =
                    '/restaurant/order/bacon%2Flettuce%2Ftomato/time/now';
                const calculated = maskResolver.calculateUrlParams(mask, url);
            ...
            describe('one parameter with slash', () => {
                it('interprets end of url as separator', () => {
                    ...
                    const calculated = maskResolver.calculateUrlParams(
                        mask,
                        url
                    );
                ...
                describe('некорректная маска', () => {
                    ...
                    it('works with presence masks', () => {
                        ...
                        expect(
                            maskResolver.calculateUrlParams.bind(
                                maskResolver,
                                mask,
                                url
                            )
            ...
            describe('one parameter with query', () => {
                ...
                it('interprets ampersand as separator 2', () => {
                    const mask = 'param=:pvalue';
                    const url =
                        '/path?firstparam=firstvalue&param=value&otherparam=othervalue';
                    const calculated = maskResolver.calculateUrlParams(
                        mask,
                        url
                    );
        ...
        describe('#calculateHref', () => {
            describe('simple masks', () => {
                ...
                describe('starting with simple params', () => {
                    ...
                    it('can add a new value', () => {
                        ...
                        expect(newUrl).toEqual(
                            '/first/fvalue/second/svalue/newval/supernew/'
                        );
                    });
                    it('can add a new value and change an existing value', () => {
                        let newUrl = maskResolver.calculateHref(
                            'first/:fvalue/newval/:value',
                            { fvalue: 'fnew', value: 'supernew' }
                        );
                        expect(newUrl).toEqual(
                            '/first/fnew/second/svalue/newval/supernew/'
                        );
                        // то же самое, но в маске порядок полей не как в url
                        newUrl = maskResolver.calculateHref(
                            'newval/:value/second/:svalue',
                            { value: 'supernew', svalue: 'snew' }
                        );
                        expect(newUrl).toEqual(
                            '/first/fvalue/second/snew/newval/supernew/'
                        );
                    });
                ...
                describe('starting with query', () => {
                    ...
                    it('can add a new value', () => {
                        ...
                        expect(newUrl).toEqual(
                            '/newval/supernew?qfrst=fvalue&qscnd=svalue'
                        );
                    });
                });
                describe('starting with simple params and query', () => {
                    ...
                    it('can remove an existing value', () => {
                        ...
                        expect(newUrl).toEqual(
                            '/second/svalue/?qfrst=fvalue&qscnd=svalue'
                        );
                    });
            ...
            describe('multiparam masks', () => {
                ...
                describe('starting with simple params', () => {
                    ...
                    it('can add a new value', () => {
                        ...
                        expect(newUrl).toEqual(
                            '/first/fvalue/second/svalue/newname/a/b/'
                        );
                    });
                    it('can remove an existing value', () => {
                        const newUrl = maskResolver.calculateHref(
                ...
                describe('starting with query', () => {
                    ...
                    it('can add a new value', () => {
                        ...
                        expect(newUrl).toEqual(
                            '/newname/a/b?qfrst=fvalue&qscnd=svalue'
                        );
                    });
                });
                describe('starting with simple params and query', () => {
                    ...
                    it('can change an existing value', () => {
                        ...
                        expect(newUrl).toEqual(
                            '/first/ast/bst/cst/?qfrst=fvalue&qscnd=svalue'
                        );
                    });
                    it('can add a new value', () => {
                        const newUrl = maskResolver.calculateHref(
                    ...
                    it('can remove an existing value', () => {
                        ...
                        expect(newUrl).toEqual(
                            '/svalue/?qfrst=fvalue&qscnd=svalue'
                        );
                    });
                    it('can replace value', () => {
                        const newUrl = maskResolver.calculateHref(
                ...
                describe('query masks', () => {
                    ...
                    describe('starting with simple params', () => {
                        it('can add a new value', () => {
                            ...
                            expect(newUrl).toEqual(
                                '/first/fvalue/second/svalue/?qfrst=abc'
                            );
                        });
                    ...
                    describe('starting with query', () => {
                        ...
                        it('can change an existing value and add new param', () => {
                            const newUrl = maskResolver.calculateHref(
                                'qfrst=:vfrst&qthrd=:vthrd',
                                { vfrst: '', vthrd: 'three' }
                            );
                            expect(newUrl).toEqual(
                                '/?qfrst=&qscnd=svalue&qthrd=three'
                            );
                        });
                        ...
                        it('can add a new value', () => {
                            ...
                            expect(newUrl).toEqual(
                                '/?qfrst=fvalue&qscnd=svalue&qthrd=abc'
                            );
                        });
                        it('can remove an existing value', () => {
                            const newUrl = maskResolver.calculateHref(
                    ...
                    describe('starting with simple params and query', () => {
                        ...
                        it('can remove an existing value', () => {
                            ...
                            expect(newUrl).toEqual(
                                '/first/fvalue/second/svalue/?qfrst=fvalue'
                            );
                        });
                    });
                });
                ...
                describe('shared cases', () => {
                    describe('simple param', () => {
                        beforeEach(() => {
                            routerUrl.setStateUrl(
                                '/first/special%20param/second/svalue'
                            );
                        });
                        ...
                        it('can change encoded value to encoded value', () => {
                            ...
                            expect(newUrl).toEqual(
                                '/first/has%20spaces/second/svalue'
                            );
                        });
                        ...
                        it('can change unencoded value to encoded value', () => {
                            ...
                            expect(newUrl).toEqual(
                                '/first/special%20param/second/with%2Fslash'
                            );
                        });
                    ...
                    describe('query param', () => {
                        beforeEach(() => {
                            routerUrl.setStateUrl(
                                '/?qfrst=special%20value&qscnd=svalue'
                            );
                        });
                        ...
                        it('can change encoded value to encoded value', () => {
                            ...
                            expect(newUrl).toEqual(
                                '/?qfrst=with%20spaces&qscnd=svalue'
                            );
                        });
                        it('can change encoded value to unencoded value', () => {
                            const newUrl = maskResolver.calculateHref(
                        ...
                        it('can change unencoded value to encoded value', () => {
                            ...
                            expect(newUrl).toEqual(
                                '/?qfrst=special%20value&qscnd=my%24money'
                            );
                        });
                        it('can remove encoded value', () => {
                            const newUrl = maskResolver.calculateHref(
            ...
            describe('fragments with slash', () => {
                ...
                it('can add a new value', () => {
                    ...
                    expect(newUrl).toEqual(
                        '/path/#first/fvalue/second/svalue/newval/supernew'
                    );
                });
            });
