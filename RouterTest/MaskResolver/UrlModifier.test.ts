 ...
 */
import { UrlModifier, UrlQueryModifier } from 'Router/_private/MaskResolver/UrlModifier';
...
describe('Router/_private/MaskResolver/UrlModifier', () => {
    describe('singleparam path url', () => {
        ...
        it('add value and change value', () => {
            ...
            expect(modifier.modify()).toEqual('/path/param/newvalue/second/svalue/');
        });
        it('remove value', () => {
        ...
        it('mask with trailing slash', () => {
            const modifier = new UrlModifier('/update/', { trailingSlash: true }, '/');
    ...
    describe('multiparam path url', () => {
        it('add value', () => {
            ...
            expect(modifier.modify()).toEqual('/path/param/newvalue/snewvalue/');
        });
        describe('change value', () => {
            ...
            it('(2)', () => {
                const modifier = new UrlModifier(
                    'param/:valueId/:svalueId',
                    { valueId: 'value', svalueId: 'snewvalue' },
                    '/param/value/value/'
                );
                expect(modifier.modify()).toEqual('/param/value/snewvalue/');
            });
        });
        it('add value and change value', () => {
            const modifier = new UrlModifier(
            ...
            expect(modifier.modify()).toEqual('/path/param/newvalue/snewvalue/second/svalue/');
        });
        it('remove value', () => {
            let modifier = new UrlModifier(
                'param/:valueId/:svalueId',
    ...
    describe('query url', () => {
        ...
        it('remove an existing value', () => {
            ...
            expect(modifier.modify()).toEqual('/auth/?rel=http://pre-test-online.sbis.ru/events');
        });
        it('replace url', () => {
            const modifier = new UrlModifier(
                'newpath=:valueId',
    ...
    describe('complicated mask', () => {
        describe('path + query', () => {
            ...
            it('change value', () => {
                ...
                expect(modifier.modify()).toEqual('/shop/pamagiti/tab/about?mode=edit');
            });
            it('add value and change value', () => {
                const modifier = new UrlModifier(
            ...
            it('replace url', () => {
                ...
                expect(modifier.modify()).toEqual('/param/value/second/newvalue?query=qvalue');
            });
            it('mask without trailing slash', () => {
                const modifier = new UrlModifier('/update?query=:val', { val: 'value' }, '/');
        ...
        describe('path + query fragment', () => {
            ...
            it('change value', () => {
                ...
                expect(modifier.modify()).toEqual('/param/pvalue/tab/about#mode=edit');
            });
            it('add value and change value', () => {
                const modifier = new UrlModifier(
            ...
            it('replace url', () => {
                ...
                expect(modifier.modify()).toEqual('/param/value/second/newvalue#fragment=fvalue');
            });
            it('mask without trailing slash', () => {
                const modifier = new UrlModifier('/update#fragment=:val', { val: 'value' }, '/');
        ...
        describe('query + path fragment', () => {
            it('add value', () => {
                ...
                expect(modifier.modify()).toEqual('/path/?query=newvalue#fragment/newfragment');
                modifier = new UrlModifier(
                    'query=:qvalue#fragment/:fvalue',
                    { qvalue: 'newvalue', fvalue: 'newfragment' },
                    '/path#oldFragment/value'
            ...
            it('change value', () => {
                ...
                expect(modifier.modify()).toEqual('/?query=qvalue&tab=about#mode/edit');
            });
            it('add value and change value', () => {
                const modifier = new UrlModifier(
            ...
            it('replace url', () => {
                ...
                expect(modifier.modify()).toEqual('/?query=value&second=newvalue#fragment/fvalue');
            });
        });
    });
    ...
    describe('immutable config properties - UrlModifier', () => {
        it('deleting "replace" option in UrlModifier', () => {
            ...
            const modifier = new UrlModifier('param/:valueId', cfg, '/path/old');
            expect(modifier.modify()).toEqual('/param/newvalue');
        });
    });
    describe('immutable config properties - UrlQueryModifier', () => {
        it('deleting "replace" option in', () => {
            ...
            const modifier = new UrlQueryModifier(cfg, '/path/?some=query#fragment');
            expect(modifier.modify()).toEqual('/path/?valueId=newvalue#fragment');
        });
        ...
        it('deleting "clearFragment" option in', () => {
            ...
            const modifier = new UrlQueryModifier(cfg, '/path/?some=query#fragment');
            expect(modifier.modify()).toEqual('/path/?some=query&valueId=newvalue');
        });
    });
});
