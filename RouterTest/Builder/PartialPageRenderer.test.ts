...
describe('Router/_Builder/_Bootstrap/PageRenderer:PartialPageRenderer', () => {
    ...
    beforeEach(() => {
        ...
        renderStartSpy = jest
            ...
            .mockImplementation();
        renderSpy = jest.spyOn(PartialHtmlGenerator.prototype, 'render').mockImplementation();
        renderEndSpy = jest.spyOn(PartialHtmlGenerator.prototype, 'renderEnd').mockImplementation();
    });
