...
import { renderEmptyDemoHTML, renderHTML } from './_Bootstrap/html/renderHTML';
...
function renderEmptyDemoStatic(options: IRenderBuilderOptions): string {
    ...
    const fullData = new DataAggregator(options, moduleName)
        .add(new EmptyDemoWsConfig())
