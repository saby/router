...
import type { ReactElement, Ref, JSXElementConstructor, ReactNode } from 'react';
 ...
 *
 * <a href="https://link.sbis.ru/article/9e0b0406-295b-4bc9-a53e-693244dc7bad#toc_5c8657d5-0e15-4220-872b-590f6c00c39a">Статья о компоненте</a>
 *
 * @example
    ...
    implements IRegisterableComponent
{
    ...
    render(): ReactElement {
        const addProps: { onMouseOverCallback?: Function; 'data-qa'?: unknown } = {};
    ...
    protected _mouseoverHandler(): void {
        if (this.props.recalcUrlBeforeNavigate) {
            this.setState(recalcHref(this.props, this.Router, this.Router.url.getLogicUrl()));
        }
    }
