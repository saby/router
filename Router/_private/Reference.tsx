 ...
 * @public
 */
export type TReferenceProps = IReferenceProps & Record<string, unknown>;
 ...
 */
class Reference
    extends Component<TReferenceProps, IReferenceState>
    implements IRegisterableComponent
{
     ...
     * Конструктор класса
     */
    constructor(props: TReferenceProps, context: IRouter) {
        super(props);
...
export default wrapReferenceToContext(Reference);
export { Reference };

function recalcHref(
    props: TReferenceProps,
    router: IRouter,
    currentUrl?: string
