import { Component, cloneElement, ReactNode, Ref } from 'react';
...
import { wrapRouteToContext } from './context/wrapToContext';
...
export interface IRouteProps {
     ...
     * @event
     * @param newParameters Значения параметров после перехода
     * @param oldParameters Значения параметров до перехода
     * @example
     * <pre>
     ...
     * </pre>
     */
    onUrlChange?: (newParameters: object, oldParameters: Object) => boolean | Promise<boolean>;
...
export default wrapRouteToContext(Route);
export { Route };
