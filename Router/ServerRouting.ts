...
import { extractS3modFromUrl } from 'Router/router';
...
export { TGetDataToRender, IModuleFound } from './_ServerRouting/Interfaces/IModuleLoader';
...
export async function getPageSource(
    ...
    // @ts-ignore
    const response = process.domain?.res || {};
